...
$select_student_result = mysqli_query($con, $select_query) or die(mysqli_error($con));
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="row">
	...
	<div class="col-xs-11 col-md-4 teacher" >
		...
		<table>
			<th>STUDENT Id</th><th>A1</th>A2<th>A3</th>A4<th>A5</th>
		<?php
	     while($std = mysqli_fetch_array($select_query_result)) 
		 { ?>
